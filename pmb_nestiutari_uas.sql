...
(1, 'ayuuu', 'sukabumi', 'wanita', 'islam'),
(2, 'Nesti Utari', 'sukabumi', 'wanita', 'islam'),
(3, 'Fikri', 'Bogor', 'pria', 'islam'),
(4, 'Stefan William', 'Jakarta', 'pria', 'kristen');
